package com.service.select.employee.config.odata;

import com.service.select.employee.service.odata.v2.ODataJpaServiceFactory;
...
public class JerseyConfig extends ResourceConfig {
    ...
    public JerseyConfig(ODataJpaServiceFactory serviceFactory, EntityManagerFactory entityManagerFactory) {
        ...
        super.register(new ODataServiceRootLocator(serviceFactory));
        super.register(new EntityManagerFilter(entityManagerFactory));
    }
